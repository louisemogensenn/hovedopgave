...
export default function Knap({ knaptekst, onClick, onPreviewClick }) {
  ...
  return (
    <>
      <section className={mystyle.knapOgPreview}>
        <button className={mystyle.knap} onClick={onClick}>
          <p>{knaptekst}</p>
        </button>
        {erDownload && (
          <p className={mystyle.preview} onClick={onPreviewClick}>
            Preview
          </p>
        )}
      </section>
