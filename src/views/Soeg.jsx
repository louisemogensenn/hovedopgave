  ...
  return (
    <article>
      {soegeTekst.length === 0 ? ( // Via en ternær operator tjekkes om søgeteksten er tom
        <p className={mystyle.tekst}>Skriv søgeord</p> ) // Hvis dette er tilfældet vises denne tekst
      : resultater.length > 0 ? ( // Ellers tjekkes det om der er fundet resultater
        <>
          <p className={mystyle.tekst}>Fundet {resultater.length} resultater</p> {/* Hvis dette er tilfældet angivet hvor mange resultater, der er fundet */}
